const TryNow = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-white px-4 py-16">
      ...
      {/* Fixed classname -> className and aligned content */}
      <div className="bg-white rounded-2xl shadow-lg p-10 flex flex-col items-center space-y-4">
        ...
        <label
          htmlFor="upload2"
          className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-full text-lg cursor-pointer"
        >
          Upload Image
        </label>
