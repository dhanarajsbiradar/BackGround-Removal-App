    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
      ...
      <div className="order-1 md:order-2">
        ...
        <p className="text-gray-600 mb-8 text-lg leading-relaxed">
          ...
          variety of new designs and destinations. Try it now to immerse your
        ...
        <div>
          ...
          <label
            htmlFor="upload1"
            className="font-medium px-8 py-4 rounded-full hover:opacity-90 transition-transform hover:scale-105 text-lg bg-black text-white cursor-pointer"
          >
            Upload Image
          </label>
        </div>
